...
function LoginModal({ onHide }: { onHide: () => void }): JSX.Element {
    const [formLoginState, setFormLoginState] = useState<string>('login');
    const [filteredForm, setFilteredForm] = useState<FormType | undefined>(undefined);

    const loginRegisterForm: FormType[] = useMemo(
        () => [
            {
                type: 'login',
